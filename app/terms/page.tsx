  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      ...
      <div className="mt-6 space-y-4 text-sm leading-7 text-ink-soft">
        {ru ? (
          <>
            <p>Входя на Toichakyru, вы соглашаетесь пользоваться сервисом для создания приглашений.</p>
          ...
          <>
            <p>Toichakyru сайтына кирип, чакыруу түзүү кызматын колдонууга макулдук бересиз.</p>
