...
export function inviteFromTemplate(tpl: InvitationTemplate): Invitation {
  ...
  return {
    ...
    address: c.address ?? PREVIEW_INVITE.address,
    city: c.city ?? PREVIEW_INVITE.city,
    dressCode: c.dressCode ?? PREVIEW_INVITE.dressCode,
    mapUrl: c.mapUrl ?? PREVIEW_INVITE.mapUrl,
