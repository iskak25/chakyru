...
export const pinterestDesigns: PinterestDesign[] = [
  { key: "ethno", id: "pin-kyz-ethno", pin: "720998221637252803", title: "Кыз узатуу — Этно", format: "site3d", paper: "#fffdf8", ink: "#864437", accent: "#a7563c", names: "Анель", date: "2026-04-25", time: "16:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: {
  ...
  { key: "burgundy", id: "pin-kyz-burgundy", pin: "1065945805577372353", title: "Кыз узатуу — Камилла", format: "site3d", paper: "#f5eadd", ink: "#6b2b2b", accent: "#7d171c", names: "Камилла", date: "2026-06-06", time: "17:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: {
  ...
  { key: "goldBride", id: "pin-kyz-gold-bride", pin: "859061697710284875", title: "Кыз узатуу — Золотой орнамент", format: "site3d", paper: "#ffffff", ink: "#817363", accent: "#cbb872", names: "Жанару", date: "2025-06-15", time: "19:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: {
    hero: raw("859061697710284875",736,1308,23,225,218,252), footer: raw("859061697710284875",736,1308,494,872,216,228),
  } },
  { key: "pearl", id: "pin-kyz-pearl", pin: "159455643066435049", title: "Кыз узатуу — Шёлк и жемчуг", format: "site3d", paper: "#faf8ee", ink: "#50413c", accent: "#58433e", names: "Алуа", date: "2026-06-06", time: "16:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: {
  ...
  { key: "blue", id: "pin-kyz-blue", pin: "8162843071272656", title: "Кыз узатуу — Синие орхидеи", format: "site3d", paper: "#ffffff", ink: "#141329", accent: "#0c0b24", names: "Айдана", date: "2025-10-25", time: "17:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: {
    hero: raw("8162843071272656",736,1472,30,82,325,357), flowers: raw("8162843071272656",736,1472,377,140,164,124),
  } },
  { key: "silkCard", id: "pin-jpg-silk", pin: "1101130177700426062", title: "JPG — Шёлк и олива", format: "photo", paper: "#f2ebdd", ink: "#353b2b", accent: "#a17b37", names: "Lena & Emil", date: "2026-06-20", time: "17:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: { hero: clean("gold",1024,1536) } },
  { key: "nikahCard", id: "pin-jpg-nikah", pin: "1132514637566318009", title: "JPG — Никах", format: "photo", paper: "#eeeeed", ink: "#a67722", accent: "#946411", names: "Ринат & Лилия", date: "2026-04-24", time: "15:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: { hero: clean("hands",939,1675) } },
  { key: "monoCard", id: "pin-jpg-monochrome", pin: "1120059369853155022", title: "JPG — Вместе за руку", format: "photo", paper: "#a4a4a4", ink: "#ffffff", accent: "#ffffff", names: "Malek & Rand", date: "2026-07-11", time: "20:30", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: { hero: clean("mono",941,1672) } },
  { key: "newspaper", id: "pin-jpg-newspaper", pin: "1146869861388231089", title: "JPG — Свадебная газета", format: "photo", paper: "#eeefec", ink: "#161714", accent: "#383a36", names: "Warner & Spencer", date: "2026-11-23", time: "10:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos: { hero: raw("1146869861388231089",735,1029,326,252,408,616) } },
];
...
export const themedSiteDesigns: PinterestDesign[] = [
  { key:"jentekCradle", id:"theme-jentek-cradle", pin:"685884218295084312", title:"Жентек той — Алтын бешик", format:"site3d", themed:true, eventType:"jentek", paper:"#fbf6ec", ink:"#594434", accent:"#946b37", names:"Барсбек", date:"2027-05-15", time:"15:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos:{hero:clean("jentek",1024,1536)} },
  { key:"tushooGarden", id:"theme-tushoo-garden", pin:"1122170432185623344", title:"Тушоо той — Первые шаги", format:"site3d", themed:true, eventType:"tushoo", paper:"#fbfcf6", ink:"#354c3e", accent:"#5e7d60", names:"Арууке", date:"2027-06-12", time:"12:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos:{hero:clean("tushoo",1024,1536)} },
  { key:"glam", id:"theme-bachelorette-glam", pin:"836754805815479181", title:"Девичник — Glam & Fabulous", format:"site3d", themed:true, eventType:"bachelorette", paper:"#100d10", ink:"#f9e8ee", accent:"#da88ab", names:"Алина", date:"2027-04-25", time:"19:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos:{hero:clean("glam",1060,1484)} },
  { key:"blushParty", id:"theme-bachelorette-blush", pin:"628533691790847296", title:"Девичник — Розовые секреты", format:"site3d", themed:true, eventType:"bachelorette", paper:"#fff5f2", ink:"#765452", accent:"#ce8596", names:"Милана", date:"2027-04-25", time:"18:00", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, photos:{hero:clean("blush",1024,1536)} },
...
export const pinterestTemplates: InvitationTemplate[] = [...pinterestDesigns,...themedSiteDesigns].map(d => ({
  id:d.id, name:{ru:localizedTitles[d.key][0],ky:localizedTitles[d.key][1]}, designer:"Toichakyru Studio", format:d.format, priceSom:d.format === "photo" ? 199 : 990, eventTypes:[d.eventType || (d.format === "photo" ? "wedding" : "kyz")],
  ...
  canvas:{names:d.names,date:d.date,time:d.time,venue:d.venue,address:d.address,city:"",message:"",dressCode:"",mapUrl: DEFAULT_VENUE.mapUrl,coverImage:"",musicUrl:"",layout:{},extras:[],gallery:{},blockColors:{},copy:{"pinterest.design":d.key}},
}));
