...
const seedTemplates: InvitationTemplate[] = [
  ...
  {
    id: "kyial",
    name: { ky: "Кыял", ru: "Мечта" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "toi"],
    featured: true,
    priceSom: 1,
    style: style("linear-gradient(165deg, #f3e6d0 0%, #ddc79a 100%)", "rgba(255,250,240,0.96)", "#b8925a", "#3d2f22", "#8a7a64", {
      overlay: "#2f4a3a",
      pageBg: "#f6efe2",
      pageLayout: "kyrgyz",
    }),
    canvas: {
      ...
      coverImage: "",
      names: "Азамат & Айпери",
      message: "Биздин жашообуздагы эң маанилүү күнүбүздү сиздер менен бирге бөлүшүүгө кубанычтабыз!",
    },
  },
  {
    id: "kyzyl-gul-anke",
    name: { ky: "Кызыл гүл", ru: "Пудровая роза" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "toi"],
    featured: true,
    ...
    canvas: {
      ...
      coverImage: "",
      names: "Елена & Дмитрий",
      message: "Приглашаем вас на самый важный день нашей жизни!",
    },
  },
  {
    id: "ak-tunuk",
    name: { ky: "Ак түнүк", ru: "Чёрно-белое" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "toi"],
    featured: true,
    priceSom: 1,
    style: style("#f4f4f2", "#ffffff", "#1a1a1a", "#1a1a1a", "#7a7a7a", {
      overlay: "#0a0a0a",
      pageBg: "#f4f4f2",
      pageLayout: "mono",
    }),
    canvas: {
      ...
      coverImage: "",
      names: "Данияр & Жаныл",
      message: "Родные и близкие! Приглашаем вас разделить с нами этот особенный день.",
    },
  },
  {
    id: "kyz-sham",
    name: { ky: "Кыз шам", ru: "Румяна" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "kyz"],
    featured: true,
    priceSom: 1,
    style: style("#fdf6f2", "#ffffff", "#c98a86", "#3a2c28", "#a5877f", {
      overlay: "#c98a86",
      pageBg: "#fdf6f2",
      pageLayout: "blush",
    }),
    canvas: {
      ...
      coverImage: "",
      names: "Айнура & Тимур",
      message: "Дорогие наши родные и друзья! Приглашаем вас разделить радость этого дня.",
    },
  },
  {
    id: "muzdak-nur",
    name: { ky: "Муздак нур", ru: "Морозный свет" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "toi"],
    featured: true,
    priceSom: 1,
    style: style("#eef2f6", "#ffffff", "#5f7a94", "#2c3a48", "#7f93a4", {
      overlay: "#5f7a94",
      pageBg: "#eef2f6",
      pageLayout: "frost",
    }),
    canvas: {
      ...
      blockColors: {},
      coverImage: "",
      names: "Ерлан & Анастасия",
      message: "Дорогие гости! С огромным счастьем приглашаем вас разделить этот зимний сказочный день вместе с нами.",
    },
  },
  {
    id: "boz-talaa",
    name: { ky: "Боз талаа", ru: "Пшеничное поле" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "toi"],
    featured: true,
    priceSom: 1,
    style: style("#f7f3ec", "#ffffff", "#7a6a4a", "#2c261c", "#8a7f68", {
      overlay: "#7a6a4a",
      pageBg: "#f7f3ec",
      pageLayout: "meadow",
    }),
    canvas: {
      ...
      coverImage: "",
      names: "Мария & Евгений",
      message: "Родные и близкие! С большой радостью приглашаем вас на празднование важного события в нашей жизни.",
    },
  },
  {
    id: "ak-dilda",
    name: { ky: "Ак дилда", ru: "Белая монета" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["toi", "wedding"],
    featured: true,
    priceSom: 1,
    style: style("#f3f6f0", "#ffffff", "#4a6a4e", "#243020", "#7a8a72", {
      overlay: "#4a6a4e",
      pageBg: "#f3f6f0",
      pageLayout: "toiAnket",
    }),
    canvas: {
      ...
      coverImage: "",
      names: "Арман & Айзада",
      message: "Урматтуу коноктор! Балдарыбыздын той-дастарканыбыздын кадырлуу коногу болууга чакырабыз.",
    },
  },
  {
    id: "kara-sham",
    name: { ky: "Кара шам", ru: "Вечерний бордо" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "toi", "anniversary"],
    featured: true,
    priceSom: 1,
    style: style("#f5f0e8", "#7a1620", "#7a1620", "#241612", "#8a7468", {
      overlay: "#7a1620",
      pageBg: "#f5f0e8",
      pageLayout: "noir",
    }),
    canvas: {
      ...
      coverImage: "",
      names: "Elena & Andrey",
      message: "Любовь — это выбор, который мы делаем каждый день. И в этот особенный вечер мы скажем друг другу «да» перед теми, кто дорог нам больше всего.",
    },
  },
  {
    id: "toskana-jel",
    name: { ky: "Тоскана жели", ru: "Тосканский бриз" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "toi"],
    featured: true,
    priceSom: 1,
    style: style("#f7f2e8", "#2c2016", "#8b5e34", "#3a2c1c", "#8a7a64", {
      overlay: "#2c2016",
      pageBg: "#f7f2e8",
      pageLayout: "tuscany",
    }),
    canvas: {
      ...
      blockColors: {},
      coverImage: "",
      names: "Алексей & Камилла",
      message: "Одна встреча, один взгляд и с этого момента мы идём по жизни вместе. Спасибо, что вы рядом в этот важный день.",
    },
  },
  {
    id: "asman-jyldyz",
    name: { ky: "Асман жылдыз", ru: "Звёздная ночь" },
    designer: "Chakyru Studio",
    format: "site3d",
    eventTypes: ["wedding", "anniversary"],
    featured: true,
    priceSom: 1,
    style: style("#0d1224", "#161c34", "#d4af67", "#eef0f6", "#8892ac", {
      overlay: "#0d1224",
      pageBg: "#0d1224",
      pageLayout: "stars",
    }),
    canvas: {
      ...
      coverImage: "",
      names: "Ethan & Olivia",
      message: "From a chance encounter on a canyon trail to an evening under the observatory dome — we invite you to celebrate the next chapter with us.",
    },
  },
];
...
const SEED_PRICE_IDS = new Set(["mauve", "ivory", "kyial", "kyzyl-gul-anke", "ak-tunuk", "kyz-sham", "muzdak-nur", "boz-talaa", "ak-dilda", "kara-sham", "toskana-jel", "asman-jyldyz"]);
