...
export const referenceWeddings: ReferenceWedding[] = [
  { id: "silk", title: "Белый шёлк", names: "Артём & Анастасия", date: "2025-09-06", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#ffffff", ink: "#65655f", accent: "#a4a59f", colors: ["#fff", "#d7d8d3", "#a3a5a0"], photos: {
  ...
  { id: "calligraphy", title: "Нежная каллиграфия", names: "Анна & Вадим", date: "2024-08-10", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#faf9f7", ink: "#171714", accent: "#dcbdb6", colors: ["#edd6d2", "#c4ada6", "#a5a798"], photos: {
    hero: crop("calligraphy", 68, 180, 304, 396), flowers: crop("calligraphy", 522, 376, 156, 57),
  } },
  { id: "winter", title: "Зимнее волшебство", names: "Ефим & Анастасия", date: "2025-12-12", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#ffffff", ink: "#657182", accent: "#6e7e90", colors: ["#b9c8d6", "#252b35", "#b9d5c2", "#d1bea0", "#f0dfe5"], photos: {
  ...
  { id: "mountains", title: "Свадьба в горах", names: "Мария & Евгений", date: "2026-08-08", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#ffffff", ink: "#33332e", accent: "#76503a", colors: ["#a59b96", "#71432b", "#343434"], photos: {
  ...
  { id: "sage", title: "Шалфей и сердца", names: "Қарлығаш & Тұзақ", date: "2025-12-09", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#ffffff", ink: "#2a3027", accent: "#91a286", colors: ["#91a286", "#526e47", "#e6e6d9"], photos: {
  ...
  { id: "rose", title: "Пудровая роза", names: "Александр & Виктория", date: "2025-08-28", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#faf5ef", ink: "#433b37", accent: "#a47b82", colors: ["#e5cbb1", "#c6a3a3", "#a47b82", "#818669", "#2e2c29"], photos: {
  ...
  { id: "burgundy", title: "Бордовый бархат", names: "Elena & Andrey", date: "2026-08-11", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#efeedb", ink: "#361c16", accent: "#60120f", colors: ["#60120f", "#c7c7c3"], photos: {
  ...
  { id: "tuscany", title: "Тоскана", names: "Алексей & Камила", date: "2025-08-10", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#f1e8db", ink: "#4a4031", accent: "#6c5739", colors: ["#e2d8cb", "#baa489", "#876744", "#211b16"], photos: {
  ...
  { id: "stars", title: "Под звёздами", names: "Ethan & Olivia", date: "2027-08-18", venue: DEFAULT_VENUE.venue, address: DEFAULT_VENUE.address, paper: "#151329", ink: "#f0eaf0", accent: "#cdb176", colors: ["#151329", "#cdb176", "#e3d8cc"], photos: {
...
export const referenceWeddingTemplates: InvitationTemplate[] = referenceWeddings.map(design => ({
  id: `reference-${design.id}`, name: { ru: design.title, ky: kyrgyzTitles[design.id] }, designer: "Toichakyru Studio", format: "site3d", priceSom: 990, eventTypes: ["wedding"],
  ...
  canvas: { names: design.names, date: design.date, time: "17:00", venue: design.venue, address: design.address, city: "", message: "", dressCode: "", mapUrl: DEFAULT_VENUE.mapUrl, coverImage: "", musicUrl: "", layout: {}, extras: [], gallery: {}, blockColors: {}, copy: { "reference.design": design.id } },
}));
