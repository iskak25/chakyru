  ...
  return (
    <article className="pointer-events-none flex h-full flex-col bg-[#fcfaf8] px-5 pb-6 pt-8 text-[#161513]">
      <div className="text-center">
        ...
        <h3 className="font-ivory mt-4 max-w-full break-words text-[34px] uppercase leading-none tracking-[0.06em]">{invitation.bride}</h3>
        <p className="font-ivory-script my-1 text-[28px] leading-none text-[#e2c2b9]">&</p>
        <h3 className="font-ivory max-w-full break-words text-[34px] uppercase leading-none tracking-[0.06em]">{invitation.groom}</h3>
  ...
  return (
    <article className="pointer-events-none relative flex h-full flex-col overflow-hidden bg-[#f7efe8] px-5 pb-6 pt-10 text-[#2b2624]">
      ...
      <div className="relative text-center">
        <h3 className="font-mauve max-w-full break-words text-[30px] uppercase leading-none tracking-[0.08em]">{invitation.groom}</h3>
        ...
        <h3 className="font-mauve max-w-full break-words text-[30px] uppercase leading-none tracking-[0.08em]">{invitation.bride}</h3>
    ...
    <article className="pointer-events-none flex h-full flex-col bg-[#eef1ea] px-4 pb-5 pt-8 text-[#141414]">
      <div>
        <p className="text-[8px] uppercase tracking-[0.36em] text-[#6d7468]">The wedding day</p>
          <h3 className="font-mod mt-3 max-w-full break-words text-[34px] font-medium uppercase leading-[0.88] tracking-[-0.04em]">
          {invitation.bride}
